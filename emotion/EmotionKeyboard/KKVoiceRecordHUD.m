...
- (void)configRecordingHUDImageWithPeakPower:(CGFloat)peakPower {
    ...
    self.recordingHUDImageView.image = [EmotionTool emotionImageWithName:imageName];
}
...
- (void)setup {
    ...
    if (!_microPhoneImageView) {
        ...
        microPhoneImageView.image = [EmotionTool emotionImageWithName:@"micro"];
    ...
    if (!_recordingHUDImageView) {
        ...
        recordHUDImageView.image = [EmotionTool emotionImageWithName:@"RecordingSignal001"];
    ...
    if (!_cancelRecordImageView) {
        ...
        cancelRecordImageView.image = [EmotionTool emotionImageWithName:@"60second"];
